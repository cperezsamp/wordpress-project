	...
	<div class="mu_register wp-signup-container" role="main">
		...
		function show_user_form($user_name = '', $user_email = '', $errors = '')
		{
			...
			<input name="user_name" type="text" id="user_name" value="<?php echo esc_attr($user_name); ?>"
				autocapitalize="none" autocorrect="off" maxlength="60" autocomplete="username" required="required"
				aria-describedby="<?php echo $errmsg_username_aria; ?>wp-signup-username-description" />
			<p id="wp-signup-username-description">
				<?php _e('(Must be at least 4 characters, lowercase letters and numbers only.)'); ?>
			</p>
			...
			<input name="user_email" type="email" id="user_email" value="<?php echo esc_attr($user_email); ?>"
				maxlength="200" autocomplete="email" required="required"
				aria-describedby="<?php echo $errmsg_email_aria; ?>wp-signup-email-description" />
			<p id="wp-signup-email-description">
				<?php _e('Your registration email is sent to this address. (Double-check your email address before continuing.)'); ?>
			</p>
		...
		function signup_another_blog($blogname = '', $blog_title = '', $errors = '')
		{
			...
			<p>
				<?php _e('If you are not going to use a great site domain, leave it for a new user. Now have at it!'); ?>
			</p>
			...
			<form id="setupform" method="post" action="wp-signup.php" novalidate="novalidate">
				...
				<?php if ('blog' === $active_signup): ?>
					...
					<fieldset class="signup-options">
						<legend>
							<?php _e('Create a site or only a username:'); ?>
						</legend>
						<p class="wp-signup-radio-buttons">
							<span class="wp-signup-radio-button">
		...
		function confirm_blog_signup($domain, $path, $blog_title, $user_name = '', $user_email = '', $meta = array())
		{
			...
			<p>
				<?php _e('But, before you can start using your site, <strong>you must activate it</strong>.'); ?>
			</p>
			<p>
				<?php
				/* translators: %s: Email address. */
			...
			<p>
				<?php _e('If you do not activate your site within two days, you will have to sign up again.'); ?>
			</p>
			...
			<ul id="noemail-tips">
				<li>
					<p><strong>
							<?php _e('Wait a little longer. Sometimes delivery of email can be delayed by processes outside of our control.'); ?>
						</strong></p>
				</li>
				<li>
